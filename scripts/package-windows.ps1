...
New-Item -ItemType Directory -Path (Join-Path $root 'app'),(Join-Path $root 'runtime/webview2'),(Join-Path $root 'data'),(Join-Path $root 'exports'),(Join-Path $root 'temp') -Force | Out-Null
